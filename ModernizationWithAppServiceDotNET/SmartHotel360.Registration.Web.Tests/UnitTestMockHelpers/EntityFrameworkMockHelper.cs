...
namespace SmartHotel360.Registration.Web.Tests.UnitTestMockHelpers
{
    public static class EntityFrameworkMockHelper
    {
        ...
        /// <summary>
        /// Use this method to mock a table, which is a DbSet{T} object, in Entity Framework.
        ...
        public static void MockTables<T>(this MockedDbContext<T> mockedContext) where T : DbContext
        {
            ...
            {
                throw new ArgumentNullException(nameof(mockedContext));
            }
