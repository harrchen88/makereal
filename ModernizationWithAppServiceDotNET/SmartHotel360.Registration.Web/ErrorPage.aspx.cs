namespace SmartHotel.Registration
{
    ...
    public partial class ErrorPage : System.Web.UI.Page
    {
        ...
        public ErrorPage(IBookingManager bookingManager, ILogger logger)
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // Log the exception.
            this.logger.Error(LogMessages.UnhandledExceptionOccurred, ModuleName.UI, ex.Message, errorHandler);
